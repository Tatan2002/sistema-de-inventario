            ...
            <?php 
                        ...
                        $categorias=$categorias->fetchALL();
                            foreach($categorias as $row) {
                                echo ' <a href="index.php?vista=productos_categories&categoria_id='.$row['categoria_id'].'" class="button is-link is-inverted is-fullwidth">'.$row['categoria_nombre'].'</a>';
                            }
                        }else{
        ...
        <div class="column">
            ...
            $categoria=$categoria->fetch();
                ...
                <p class="has-text-centered pb-6" >'.$categoria['categoria_ubicacion'].'</p>';
                    ...
                    $url="index.php?vista=productos_categories&categoria_id='.$categoria_id.'&page=";
                    $registro=15;
                    $busqueda="";
